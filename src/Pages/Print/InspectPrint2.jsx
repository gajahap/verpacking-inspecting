...
const InspectPrint = (props) => {
  ...
  useEffect(() => {
    const fetchDataAsync = async () => {
      try {
        const url = props.jenisProses === 'mkl-bj' ? 'inspecting/get-inspecting-mklbj' : 'inspecting/get-inspecting';
                      ...
                      <table style={{ width: "100%", fontSize: "13px" }}>
                        <tbody>
                          <tr>
                            ...
                            <td>: {data?.tanggal_inspeksi ? new Date(data.tanggal_inspeksi).toLocaleDateString('id-ID') : '-'}</td>
                          </tr>
                          <tr>
                      ...
                      <table style={{ width: "100%", fontSize: "13px" }}>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>: {data.kombinasi ? data.kombinasi : "-"}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>

              ...
              <Stack direction="vertical" className="justify-content-center align-items-center">
                ...
                {toastType === 'report-menu' && (
                  <>
                    ...
                    <a href="/search-panjang-defect-per-motif" className="text-decoration-none p-2 w-100" onClick={(e) => { e.preventDefault(); window.location.href = '/search-panjang-defect-per-motif'; }}>
                      <Stack direction="horizontal" gap={3} className="justify-content-center align-items-center">
                        <TbReportSearch size={25} />
                        <span className="" style={{ fontSize: '12px' }}>Search Panjang Defect By Motif</span>
                      </Stack>
                    </a>
                  </>
                )}
